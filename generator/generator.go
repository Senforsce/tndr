...
// WithFileName sets the filename of the tndr file in template rendering error messages.
...
// gopls disables edit related functionality for generated files, so the tndr LSP may
...
func (g *generator) writeCodeGeneratedComment() (err error) {
	...
	_, err = g.w.Write("// Code generated by tndr - DO NOT EDIT.\n\n")
	return err
}

func (g *generator) writeVersionComment() (err error) {
	if g.options.Version != "" {
		_, err = g.w.Write("// tndr: version: " + g.options.Version + "\n")
	}
	return err
}
...
func (g *generator) writeGeneratedDateComment() (err error) {
	if g.options.GeneratedDate != "" {
		_, err = g.w.Write("// tndr: generated: " + g.options.GeneratedDate + "\n")
	}
	return err
}
...
func (g *generator) writeImports() error {
	var err error
	// Always import tndr because it's the interface type of all templates.
	if _, err = g.w.Write("import \"github.com/senforsce/tndr\"\n"); err != nil {
		return err
	}
	if _, err = g.w.Write("import tndrruntime \"github.com/senforsce/tndr/runtime\"\n"); err != nil {
		return err
	}
	if _, err = g.w.Write("\n"); err != nil {
		return err
...
func (g *generator) writeCSS(n *parser.CSSTemplate) error {
	...
	}
	{
		...
		if _, err = g.w.WriteIndent(indentLevel, "templ_7745c5c3_CSSBuilder := tndrruntime.GetBuilder()\n"); err != nil {
			return err
		}
...
func (g *generator) writeTemplBuffer(indentLevel int) (err error) {
	// templ_7745c5c3_Buffer, templ_7745c5c3_IsBuffer := tndrruntime.GetBuffer(templ_7745c5c3_W)
	if _, err = g.w.WriteIndent(indentLevel, "templ_7745c5c3_Buffer, templ_7745c5c3_IsBuffer := tndrruntime.GetBuffer(templ_7745c5c3_W)\n"); err != nil {
		return err
	}
	// if !templ_7745c5c3_IsBuffer {
	//	defer func() {
	//		templ_7745c5c3_BufErr := tndrruntime.ReleaseBuffer(templ_7745c5c3_Buffer)
	...
	}
	{
		...
		{
			indentLevel++
			if _, err = g.w.WriteIndent(indentLevel, "templ_7745c5c3_BufErr := tndrruntime.ReleaseBuffer(templ_7745c5c3_Buffer)\n"); err != nil {
				return err
			}
...
func (g *generator) writeTemplate(nodeIdx int, t *parser.HTMLTemplate) error {
	...
	indentLevel++
	// return tndrruntime.GeneratedTemplate(func(templ_7745c5c3_Input tndrruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
	if _, err = g.w.WriteIndent(indentLevel, "return tndrruntime.GeneratedTemplate(func(templ_7745c5c3_Input tndrruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {\n"); err != nil {
		return err
	}
	{
		indentLevel++
...
func (g *generator) writeBlockTemplElementExpression(indentLevel int, n *parser.TemplElementExpression) (err error) {
	...
	if _, err = g.w.WriteIndent(indentLevel, childrenName+" := tndrruntime.GeneratedTemplate(func(templ_7745c5c3_Input tndrruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {\n"); err != nil {
		return err
	}
	indentLevel++
	if _, err = g.w.WriteIndent(indentLevel, "templ_7745c5c3_W, ctx := templ_7745c5c3_Input.Writer, templ_7745c5c3_Input.Context\n"); err != nil {
...
func (g *generator) writeExpressionAttributeValueStyle(indentLevel int, attr *parser.ExpressionAttribute) (err error) {
	...
	// vn, templ_7745c5c3_Err = tndrruntime.SanitizeStyleAttributeValues(
	if _, err = g.w.WriteIndent(indentLevel, vn+", templ_7745c5c3_Err = tndrruntime.SanitizeStyleAttributeValues("); err != nil {
		return err
	}
	// value
	if r, err = g.w.Write(attr.Expression.Value); err != nil {
...
func (g *generator) writeScriptContents(indentLevel int, c parser.ScriptContents) (err error) {
	...
	if c.GoCode != nil {
		...
		// vn, templ_7745c5c3_Err := tndrruntime.ScriptContent(
		fnCall := "tndrruntime.ScriptContentOutsideStringLiteral"
		if c.InsideStringLiteral {
			fnCall = "tndrruntime.ScriptContentInsideStringLiteral"
		}
...
// This ensures that even if the github.com/senforsce/tndr/runtime package is not used in the generated code,
// the Go compiler will not complain about the unused import.
func (g *generator) writeBlankAssignmentForRuntimeImport() error {
	var err error
	if _, err = g.w.Write("var _ = tndrruntime.GeneratedTemplate"); err != nil {
		return err
	}
	return nil
}
