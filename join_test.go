...
func TestJoin(t *testing.T) {
	...
	world := tndr.ComponentFunc(func(ctx context.Context, w io.Writer) error {
		if _, err := io.WriteString(w, "World"); err != nil {
			t.Fatalf("failed to write string: %v", err)
		}
		return nil
	})
	err := tndr.ComponentFunc(func(ctx context.Context, w io.Writer) error {
		return compErr
	})
