...
func TestWorkspaceFolders(t *testing.T) {
	...
	const want = `[{"uri":"file:///home/asy/Senforsce/src/github.com/senforsce/tndr/lsp/protocol","name":"protocol"},{"uri":"file:///home/asy/Senforsce/src/github.com/senforsce/tndr/lsp/jsonrpc2","name":"jsonrpc2"}]`
	wantType := WorkspaceFolders{
		{
			URI:  string(uri.File("/home/asy/Senforsce/src/github.com/senforsce/tndr/lsp/protocol")),
			Name: "protocol",
		},
		{
			URI:  string(uri.File("/home/asy/Senforsce/src/github.com/senforsce/tndr/lsp/jsonrpc2")),
			Name: "jsonrpc2",
		},
	}
...
func TestInitializeParams(t *testing.T) {
	...
	const (
		want    = `{"workDoneToken":"` + wantWorkDoneToken + `","processId":25556,"clientInfo":{"name":"testClient","version":"v0.0.0"},"locale":"en-US","rootPath":"~/go/src/github.com/senforsce/tndr/lsp/protocol","rootUri":"file:///home/asy/Senforsce/src/github.com/senforsce/tndr/lsp/protocol","initializationOptions":"testdata","capabilities":{},"trace":"on","workspaceFolders":[{"uri":"file:///home/asy/Senforsce/src/github.com/senforsce/tndr/lsp/protocol","name":"protocol"},{"uri":"file:///home/asy/Senforsce/src/github.com/senforsce/tndr/lsp/jsonrpc2","name":"jsonrpc2"}]}`
		wantNil = `{"processId":25556,"rootUri":"file:///home/asy/Senforsce/src/github.com/senforsce/tndr/lsp/protocol","capabilities":{}}`
	)
	wantType := InitializeParams{
		...
		Locale:                "en-US",
		RootPath:              "~/go/src/github.com/senforsce/tndr/lsp/protocol",
		RootURI:               uri.File("/home/asy/Senforsce/src/github.com/senforsce/tndr/lsp/protocol"),
		InitializationOptions: "testdata",
		Capabilities:          ClientCapabilities{},
		Trace:                 "on",
		WorkspaceFolders: []WorkspaceFolder{
			{
				Name: filepath.Base("/home/asy/Senforsce/src/github.com/senforsce/tndr/lsp/protocol"),
				URI:  string(uri.File("/home/asy/Senforsce/src/github.com/senforsce/tndr/lsp/protocol")),
			},
			{
				Name: filepath.Base("/home/asy/Senforsce/src/github.com/senforsce/tndr/lsp/jsonrpc2"),
				URI:  string(uri.File("/home/asy/Senforsce/src/github.com/senforsce/tndr/lsp/jsonrpc2")),
			},
		},
	}
