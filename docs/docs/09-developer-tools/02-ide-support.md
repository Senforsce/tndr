...
There's a VS Code extension, just make sure you've already installed tndr and that it's on your path.

- https://marketplace.visualstudio.com/items?itemName=senforsce.tndr
- https://github.com/Senforsce/tndr-vscode

VSCodium users can find the extension on the Open VSX Registry at https://open-vsx.org/extension/senforsce/tndr
...
```json
{
    ...
    "[templ]": {
        "editor.defaultFormatter": "Senforsce.tndr"
    },
}
```
...
- [tree-sitter](https://github.com/nvim-treesitter/nvim-treesitter): for synx highlighting
    - [tree sitter tndr](https://github.com/vrischmann/tree-sitter-templ)
