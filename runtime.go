...
const unknownTypeClassName = "--tndr-css-class-unknown-type"
...
// ComponentCSSClass is a tndr.CSS
...
// use tndr.Components skip rendering <style> elements for classes that are included in the global
// stylesheet. By default, the stylesheet path is /styles/tndr.css
func NewCSSMiddleware(next http.Handler, classes ...CSSClass) CSSMiddleware {
	return CSSMiddleware{
		Path:       "/styles/tndr.css",
...
// FromGoHTML creates a tndr Component from a Go html/template template.
