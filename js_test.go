...
func TestJSFuncCall(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			args:         nil,
			expected: ComponentScript{
				Name:       "jsFuncCall_9b98d058cfca1ae2f130d8a4d656563e8ba01a79987acb76dfecac36b18bef67",
				Function:   "",
				Call:       "__tndr_invalid_js_function_name()",
				CallInline: "__tndr_invalid_js_function_name()",
			},
			expectedComponentOutput: `<script>__tndr_invalid_js_function_name()</script>`,
		},
		{
