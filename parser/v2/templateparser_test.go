...
<span>{ "span content" }</span>
		...
		},
		{
			...
			input: `t1 Name(p Parameter) { <span>{ "span content" }</span> }`,
			expected: &HTMLTemplate{
				Range: Range{
					From: Position{Index: 0, Line: 0, Col: 0},
	...
	*/
	...
	-->
			...
			expected: &HTMLTemplate{
				Range: Range{
					From: Position{Index: 0, Line: 0, Col: 0},
					To:   Position{Index: 55, Line: 5, Col: 1},
				},
				Expression: Expression{
					Value: "x()",
					Range: Range{
			...
			expected: &HTMLTemplate{
				...
				Children: []Node{
					...
					&Element{
						Name: "span",
						NameRange: Range{
							From: Position{Index: 40, Line: 1, Col: 3},
							To:   Position{Index: 44, Line: 1, Col: 7},
						},
						...
						TrailingSpace:  SpaceVertical,
						Range: Range{
							From: Position{Index: 39, Line: 1, Col: 2},
							To:   Position{Index: 91, Line: 4, Col: 0},
						},
					},
				},
			},
			...
			expected: &HTMLTemplate{
				...
				Children: []Node{
					...
					&Element{
						...
						NameRange: Range{
							From: Position{Index: 14, Line: 1, Col: 2},
							To:   Position{Index: 16, Line: 1, Col: 4},
						},
						TrailingSpace: SpaceNone,
						Range: Range{
							From: Position{Index: 13, Line: 1, Col: 1},
							To:   Position{Index: 22, Line: 1, Col: 10},
						},
					},
					&Element{
						Name: "br",
						NameRange: Range{
							From: Position{Index: 23, Line: 1, Col: 11},
